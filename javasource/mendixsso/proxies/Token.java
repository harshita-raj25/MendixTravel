...
public class Token
{
	...
	{
		return getToken_Session(getContext());
	}
	...
	/**
	 * Set value of Token_Session
	 * @param token_session
	 */
	public final void setToken_Session(system.proxies.Session token_session)
	{
		setToken_Session(getContext(), token_session);
	}
