...
public class TokenRefreshResponse
{
	...
	protected TokenRefreshResponse(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject tokenRefreshResponseMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf(entityName, tokenRefreshResponseMendixObject.getType())) {
	...
	/**
	 * @return value of AccessTokenExpiresIn
	 */
	public final java.lang.Long getAccessTokenExpiresIn()
	{
		return getAccessTokenExpiresIn(getContext());
	}
	 ...
	 * @return value of AccessTokenExpiresIn
	 */
	public final java.lang.Long getAccessTokenExpiresIn(com.mendix.systemwideinterfaces.core.IContext context)
	{
		return (java.lang.Long) getMendixObject().getValue(context, MemberNames.AccessTokenExpiresIn.toString());
	}

	/**
	 * Set value of AccessTokenExpiresIn
	 * @param accesstokenexpiresin
	 */
	public final void setAccessTokenExpiresIn(java.lang.Long accesstokenexpiresin)
	{
		setAccessTokenExpiresIn(getContext(), accesstokenexpiresin);
	}
	 ...
	 * @param accesstokenexpiresin
	 */
	public final void setAccessTokenExpiresIn(com.mendix.systemwideinterfaces.core.IContext context, java.lang.Long accesstokenexpiresin)
	{
		getMendixObject().setValue(context, MemberNames.AccessTokenExpiresIn.toString(), accesstokenexpiresin);
	}
	...
	/**
	 * @return value of IdTokenExpiresIn
	 */
	public final java.lang.Long getIdTokenExpiresIn()
	{
		return getIdTokenExpiresIn(getContext());
	}
	 ...
	 * @return value of IdTokenExpiresIn
	 */
	public final java.lang.Long getIdTokenExpiresIn(com.mendix.systemwideinterfaces.core.IContext context)
	{
		return (java.lang.Long) getMendixObject().getValue(context, MemberNames.IdTokenExpiresIn.toString());
	}

	/**
	 * Set value of IdTokenExpiresIn
	 * @param idtokenexpiresin
	 */
	public final void setIdTokenExpiresIn(java.lang.Long idtokenexpiresin)
	{
		setIdTokenExpiresIn(getContext(), idtokenexpiresin);
	}
	 ...
	 * @param idtokenexpiresin
	 */
	public final void setIdTokenExpiresIn(com.mendix.systemwideinterfaces.core.IContext context, java.lang.Long idtokenexpiresin)
	{
		getMendixObject().setValue(context, MemberNames.IdTokenExpiresIn.toString(), idtokenexpiresin);
	}
