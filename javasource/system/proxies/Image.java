...
public class Image extends system.proxies.FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("Lets_Travel.GuideProfilePicture", mendixObject.getType())) {
			return lets_travel.proxies.GuideProfilePicture.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("Lets_Travel.TouristProfilePicture", mendixObject.getType())) {
			return lets_travel.proxies.TouristProfilePicture.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("Lets_Travel.image", mendixObject.getType())) {
