...
public class Account extends system.proxies.User
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("Lets_Travel.Guide", mendixObject.getType())) {
			return lets_travel.proxies.Guide.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("Lets_Travel.Tourist", mendixObject.getType())) {
